...
app.get('/list', function (req,res){
    request('http://pokeapi.co/api/v1/pokedex/1/', function (error,response,body){
        ...
        dex.pokemon.forEach(function(element,index){
          ...
          // request('http://pokeapi.co/api/v1/sprite/'+index, function (error,response,body){
          //     if (!error && response.statusCode == 200) {
          //     var object = JSON.parse(body)
          //     sprite = 'http://pokeapi.co' + object.image
          //     console.log('got sprite! for' + name)
          //     }else{
          //       // console.log("could not get sprite for " + name);
          //     }
          // })
